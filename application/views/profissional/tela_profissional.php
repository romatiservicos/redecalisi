...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header"><?php echo $query['NomeProfissional'] . ' <small>Identificador: ' . $query['idApp_Profissional'] . '</small>'; ?></h1>
            ...
            <div class=" col-md-10 col-lg-10 "> 
                <table class="table table-user-information">
                    <tbody>
                        ...
                        echo '                                                 
                        <tr>
                            <td><span class="glyphicon glyphicon-heart"></span> Funcao:</td>
                            <td>' . $query['Funcao'] . '</td>
                        </tr>
                        ';
